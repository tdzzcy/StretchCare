...
class DetectionBoxMarker:
    ...
    def broadcast_tf(self, tf_broadcaster, force_redundant=False):
        ...
        transform_stamped.transform.translation.x = float(self.marker_position[0])
        transform_stamped.transform.translation.y = float(self.marker_position[1])
        print("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        print(float(self.marker_position[0]))
        print(float(self.marker_position[2]))
        transform_stamped.transform.translation.z = float(self.marker_position[2])
